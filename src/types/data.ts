import type { SelectOptionGroup, Vechile } from './filter';
...
export type ProductItem = {
	...
	trim_id: null | number;
	is_from_rent: null | boolean;
	tmp: string;
	views: number;
	dealerId: null | number;
	has_logo: null | boolean;
	logo_ver: null | number;
	active_ads: null | number;
	dealer_title: string;
	has360: number;
...
export type ManufacturersGroupedByVechile = Record<Vechile, Manufacturer[]>;

export type CategoriesGroupedByVehicleType = Record<Vechile, Category[]>;

export type ModelsGroupedByManufacturerAndVechile = Record<
	Vechile,
	SelectOptionGroup[]
>;
